...
- **Paths:** e.g. `POST /templates/{template_id}/compile`, `POST /templates/{template_id}/send`. See the [API reference](/api-reference/introduction) for all endpoints and parameters.
- **Body:** JSON in the shape your template expects (same as [sample data](/guides/templates-sample-data)). The agent provides this payload; your tool forwards it to the API.
