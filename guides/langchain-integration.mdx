...
For **compile** (get blocks without sending), use `POST /templates/{template_id}/compile` and return the blocks to the agent or post them yourself. See the [API reference](/api-reference/introduction) for request/response shapes.
